        ...
        try:
            ...
            if domain == "compound":
                if nameSpace in ["cid", "name", "inchikey"] and returnType in ["record"] and searchType in ["lookup"] and requestType == "GET":
                    ...
                    ret, retCode = ureq.get(baseUrl, endPoint, pD, httpCodesCatch=httpCodesCatch, returnContentType="JSON")
                    ...
                    ret, retCode = ureq.post(baseUrl, endPoint, pD, httpCodesCatch=httpCodesCatch, returnContentType="JSON")
                #
